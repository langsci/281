...
\begin{table}
	...
	\begin{tabular}{l rr rr rr r}
		\lsptoprule
		\textbf{focus types}&\multicolumn{2}{c}{\textbf{falling accents}}    &	\multicolumn{2}{c}{\textbf{rising accents}}       &\multicolumn{2}{c}{\textbf{NA}} & 	\textbf{all}\\
                                    &\multicolumn{2}{c}{\textbf{(negative onglides)}} &	\multicolumn{2}{c}{\textbf{(positive onglides)}}  &		&		&	\\
		\midrule
...
\begin{table}[p]
	...
	\begin{tabular}{l rr rr rr r}
		\lsptoprule
		\textbf{focus types	} &	\multicolumn{2}{c}{\textbf{early peak}}&		\multicolumn{2}{c}{\textbf{mid to late peak}} &		\multicolumn{2}{c}{\textbf{NA}} & 	\textbf{all}\\
                                        &	\multicolumn{2}{c}{\textbf{(negative alignment)}} &	\multicolumn{2}{c}{\textbf{(positive alignment)}} &		&	&		\\
		\midrule
